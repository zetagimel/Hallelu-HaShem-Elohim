                    ...
                    <div className="space-y-6 text-sm leading-relaxed">
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                ...
                                displays advertisements from Monetag and A-Ads, third-party advertising networks.
                                These partners may use cookies and similar technologies to deliver relevant ads and measure ad
                                performance. We do not control their data collection practices. For more information
                                about their privacy practices, please visit their respective privacy policies. Users in the EEA/UK
