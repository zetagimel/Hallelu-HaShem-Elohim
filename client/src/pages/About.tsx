                    ...
                    <div className="space-y-8">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-3 text-muted-foreground">
                                ...
                                <p>
                                    <strong>Advertising:</strong> This website displays advertisements provided by Monetag and A-Ads,
                                    third-party advertising networks. They may use cookies and similar
                                    technologies to deliver relevant ads. We do not control their data collection practices.
                                </p>
                                <p>
