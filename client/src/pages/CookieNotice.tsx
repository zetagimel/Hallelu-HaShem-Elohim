                    ...
                    <div className="space-y-8">
                        ...
                        <section className="space-y-4">
                            ...
                            <ul className="space-y-3 text-muted-foreground">
                                ...
                                <li>
                                    <strong>Monetag</strong> — specific ad format delivery (interstitials, vignettes); employs cookies for frequency capping and ad performance metrics.
                                </li>
                                <li>
                                    <strong>A-Ads</strong> — anonymous advertising network; does not use cookies or track user personal data.
                                </li>
                                <li>
