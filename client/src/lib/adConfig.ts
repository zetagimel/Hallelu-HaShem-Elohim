...
export const AD_CONFIG = {
  // Monetization Configuration (Monetag & A-Ads)
  monetization_partners: {
    monetag: {
      enabled: true,
      accountEmail: "your@email.com",
      zones: {
        // Vignette Banner (High CPM)
        vignette: {
          zoneId: "YOUR_MONETAG_ZONE_ID_VIGNETTE",
          type: "interstitial",
          frequency: "every-page-load"
        },
        // In-Page Push (High CTR)
        inPagePush: {
          zoneId: "YOUR_MONETAG_ZONE_ID_INPAGE_PUSH",
          type: "push",
          position: "top-right",
          enabled: true
        },
        ...
        directLink: {
          url: "https://your-monetag-direct-link.com",
          enabled: true,
          placement: "refresh-button"
        }
      }
    },
    a_ads: {
      ...
      zones: {
        // Footer Banner
        footerBanner: {
          iframeUrl: "https://ad.a-ads.com/iframe/YOUR_ZONE_ID",
          size: "Adaptive",
          placement: "footer"
        }
      }
